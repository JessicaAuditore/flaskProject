...
import model.network.nn.mynn as mynn
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        # 对应AlignNetResNet中的resnet.layer0
        # self.conv1 = nn.Sequential(
        #     conv3x3(3, 64, stride=2),  # 尺寸缩小1/2，通道64
        #     mynn.Norm2d(64),
        #     nn.ReLU(inplace=True),
        #
        #     conv3x3(64, 64),  # 尺寸不变，通道64
        #     mynn.Norm2d(64),
        #     nn.ReLU(inplace=True),
        #
        #     conv3x3(64, 128)  # 尺寸不变，通道128
        # )

        # 改进的Aresnet,对应AlignNetResNet中的resnet.layer0
        self.conv1 = nn.Sequential(
            conv3x3(3, 32, stride=2),  # 尺寸缩小1/2，通道64
            mynn.Norm2d(32),
            nn.ReLU(inplace=True),

            conv3x3(32, 64),  # 尺寸不变，通道64
            mynn.Norm2d(64),
            nn.ReLU(inplace=True),
        ...
        # 对应AlignNetResNet中的resnet.layer1
